...
import { C31AddRemoveObstacles, C32StopReleaseDuck } from './jsx/allLiveEditors';
...
- whenever we click on a sphere, a red cube will appear at the same clicked position
- clicking a cube will make itself disappear

<C31AddRemoveObstacles />
