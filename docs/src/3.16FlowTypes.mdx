...
Flow types are supported. To use the type, import directly from `regl-worldview`. More type definitions: <GithubLink href="https://github.com/cruise-automation/webviz/blob/master/packages/regl-worldview/src/types/index.js" />
