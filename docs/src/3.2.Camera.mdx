...
**Uncontrolled** using `defaultCameraState` as props. _Notice that the cameraState doesn't change as you change the distance in the input._ ([Understanding uncontrolled components](https://reactjs.org/docs/uncontrolled-components.html))
