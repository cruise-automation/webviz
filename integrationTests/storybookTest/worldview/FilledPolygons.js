...
import { FilledPolygons, type PoylgonType } from "regl-worldview";

import { generateNonInstancedClickTests } from "../testUtils";
...
const FilledPolygonTests: IntegrationTestModule = {
  name: "FilledPolygons",
  tests: [
    ...generateNonInstancedClickTests<PoylgonType>("FilledPolygon", FilledPolygons, twoFilledPolygonsInARow, {
...
export default FilledPolygonTests;
