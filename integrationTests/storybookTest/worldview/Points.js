...
import { Points, type Point } from "regl-worldview";
...
const PointsTests: IntegrationTestModule = {
  name: "Points",
  tests: [
    ...generateNonInstancedClickTests<Point>("Point", Points, twoPointsInARow),
    ...generateInstancedClickTests<Point>("Point", Points, instancedPoints),
  ],
};

export default PointsTests;
