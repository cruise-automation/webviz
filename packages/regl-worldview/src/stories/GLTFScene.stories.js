...
storiesOf("Worldview/GLTFScene", module)
  ...
  .add("<GLTFScene> - Load a scene from a file with Draco-compressed buffers (uncompressed)", () => {
    const model = require("common/fixtures/Duck-Uncompressed.glb");
    return (
      <Worldview
        defaultCameraState={{
          distance: 25,
  ...
  .add("<GLTFScene> - Load a scene from a file with Draco-compressed buffers (car compressed)", () => {
    const model = require("common/fixtures/compressed.glb");
    return (
      <Worldview
        defaultCameraState={{
          distance: 25,
  ...
  .add("<GLTFScene> - Load a scene from a file with Draco-compressed buffers (car uncompressed)", () => {
    const model = require("common/fixtures/uncompressed.glb");
    return (
      <Worldview
        defaultCameraState={{
          distance: 25,
