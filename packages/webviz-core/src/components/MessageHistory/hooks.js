...
import { useRef, useLayoutEffect, useState, useContext, createContext } from "react"; // eslint-disable-line import/no-duplicates
...
export type SelectableContext<T> = {|
  ...
  +_ctx: React.Context<?SelectableContextHandle<T>>,
|};
