...
function parsedMessageDefinitionsToDatatypes(
  ...
  topLevelDatatypeNames.forEach((datatypeName) => {
    ...
    datatypes[datatypeName] = {fields: parsedMessageDefinition};
  });
  return datatypes;
}

export default function pbMessageDefinitionsToParsed(
  ...
  for (const topic of Object.keys(messageDefinitions.messageDefinitionsByTopic)) {
    ...
    parsedMessageDefinitionsByTopic[topic] = messageDefinition;
  }
  return {
    type: "parsed",
