...
/*
We've split this code out seperately from the rest of the hooks so that we can
lazy load these components by lazily importing this file at runtime.
*/

export function panelsByCategory() {
  const Audio = require('webviz-core/src/panels/Audio').default;
  const DiagnosticStatusPanel =
      require('webviz-core/src/panels/diagnostics/DiagnosticStatusPanel')
          .default;
  const DiagnosticSummary =
      require('webviz-core/src/panels/diagnostics/DiagnosticSummary').default;
  const GlobalVariables =
      require('webviz-core/src/panels/GlobalVariables').default;
  const GlobalVariableSlider =
      require('webviz-core/src/panels/GlobalVariableSlider').default;
  const GlobalVariableDropdown =
      require('webviz-core/src/panels/GlobalVariableDropdown').default;
  ...
  const NodePlayground =
      require('webviz-core/src/panels/NodePlayground').default;
  const Note = require('webviz-core/src/panels/Note').default;
  const NumberOfRenders =
      require('webviz-core/src/panels/NumberOfRenders').default;
  const PlaybackPerformance =
      require('webviz-core/src/panels/PlaybackPerformance').default;
  ...
  const StateTransitions =
      require('webviz-core/src/panels/StateTransitions').default;
  const SubscribeToList =
      require('webviz-core/src/panels/SubscribeToList').default;
  const Tab = require('webviz-core/src/panels/Tab').default;
  const TwoDimensionalPlot =
      require('webviz-core/src/panels/TwoDimensionalPlot').default;
  const ThreeDimensionalViz =
      require('webviz-core/src/panels/ThreeDimensionalViz').default;
...
export function perPanelHooks() {
  ...
  const HexagonMultipleIcon =
      require('@mdi/svg/svg/hexagon-multiple.svg').default;
  const PentagonOutlineIcon =
      require('@mdi/svg/svg/pentagon-outline.svg').default;
  ...
  const {
    ...
    RADAR_POINT_CLOUD,
    WRAPPED_POINT_CLOUD,
    CARGO_MAIN_LIDAR_LEFT_MSG,
  } = require('webviz-core/src/util/globalConstants');

  const sceneBuilderHooks =
      require(
          'webviz-core/src/panels/ThreeDimensionalViz/SceneBuilder/defaultHooks')
          .default;
  const supportsOffscreenCanvas =
      require('webviz-core/src/util/supportsOffscreenCanvas').default;
  const initLayoutNonWorker =
      require('webviz-core/src/panels/ThreeDimensionalViz/Layout/LayoutWorker')
          .default;
  const useStaticTransformsData =
      require(
          'webviz-core/src/panels/ThreeDimensionalViz/Transforms/useStaticTransformsData')
          .default;
  ...
  return {
    ...
    StateTransitions:
        {defaultConfig: {paths: []}, customStateTransitionColors: {}},
    ThreeDimensionalViz: {
      defaultConfig: {
      ...
      // TODO(useWorkerIn3DPanel): Remove sceneBuilderHooks when flag is
      // deleted.
      sceneBuilderHooks,
      useWorldContextValue:
          require(
              'webviz-core/src/panels/ThreeDimensionalViz/SceneBuilder/useWorldContextValue')
              .default,
      getLayoutWorker: () => {
        if (supportsOffscreenCanvas()) {
          const WorkerType = require(
              'webviz-core/src/panels/ThreeDimensionalViz/Layout/Layout.worker');
