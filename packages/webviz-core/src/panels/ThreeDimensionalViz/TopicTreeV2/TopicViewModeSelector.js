...
// TODO(Audrey):remove SHOW_TREE after TopicTreeV2 release.
...
export default function TopicViewModeSelector({
  ...
  let topicDisplayMode = TOPIC_DISPLAY_MODES[topicDisplayModeProp] ? topicDisplayModeProp : DEFAULT_DISPLAY_MODE;
  // TODO(Audrey): remove once TopicTreeV2 is launched.
  topicDisplayMode = topicDisplayMode === TOPIC_DISPLAY_MODES.SHOW_TREE.value ? DEFAULT_DISPLAY_MODE : topicDisplayMode;
  return (
