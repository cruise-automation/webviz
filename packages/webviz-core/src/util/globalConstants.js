...
export const SEEK_TO_RELATIVE_MS_QUERY_KEY =
    'seek-by';  // Only used on load. Can be negative.
...
export const TEST_EVERYTHING_LAYOUT_QUERY_VAL =
    '_integration-test-everything-layout';
...
export const VISUALIZATION_MSGS$WEBVIZ_MARKER =
    'visualization_msgs/WebvizMarker';
export const VISUALIZATION_MSGS$WEBVIZ_MARKER_ARRAY =
    'visualization_msgs/WebvizMarkerArray';
export const FUTURE_VISUALIZATION_MSGS$WEBVIZ_MARKER_ARRAY =
    'future_visualization_msgs/WebvizMarkerArray';
...
export const CARGO_MAIN_LIDAR$MSG = 'proto_msg/PointCloud';
export const CARGO_MAIN_LIDAR_LEFT_MSG = '/cargo/lidar/main/left';

export const WEBVIZ_ICON_MSGS$WEBVIZ_2D_ICON_ARRAY =
    'webviz_icon_msgs/WebViz2dIconArray';
export const WEBVIZ_ICON_MSGS$WEBVIZ_3D_ICON_ARRAY =
    'webviz_icon_msgs/WebViz3dIconArray';
...
// In testing there seems to be a small (~4%) performance penalty to freezing
// messages, so for now we only do it in development/testing. StackOverflow says
// that there should be no difference though:
// https://stackoverflow.com/questions/8435080/any-performance-benefit-to-locking-down-javascript-objects
// So maybe we want to always do the freezing at some point? Probably requires
...
export const POSE_MARKER_SCALE = {
  x: 2,
  y: 2,
  z: 0.1
};
...
export const MILES_PER_HOUR_TO_METERS_PER_SECOND =
    1 / METERS_PER_SECOND_TO_MILES_PER_HOUR;
...
export const FEATURE_ANNOUNCEMENTS_LOCAL_STORAGE_KEY =
    'webvizFeatureAnnouncements';

export const MIN_MEM_CACHE_BLOCK_SIZE_NS =
    0.1e9;  // Messages are laid out in blocks with a fixed number of
            // milliseconds.
